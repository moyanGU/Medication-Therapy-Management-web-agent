<template>
  <div class="relative min-h-screen bg-gray-50 overflow-hidden">
    <div
      class="absolute inset-0 pointer-events-none bg-center bg-cover opacity-20 blur-xl scale-125"
      style="background-image: url('/images/mtm-cover-logo.svg')"
    ></div>
    <div class="absolute inset-0 pointer-events-none bg-slate-50/70"></div>
    <!-- 主要内容区域 -->
          ...
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-semibold text-gray-900">
                {{ medicineStats?.total_medicines ?? 0 }}
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-2xl font-semibold text-gray-900">
                {{ medicineStats?.expiring_soon_count ?? 0 }}
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div class="flex items-center mb-4">
            <div
              class="p-3 bg-blue-100 rounded-lg group-hover:bg-blue-200 transition-colors duration-200"
            >
              <svg
        ...
        >
          <div class="flex items-center mb-4">
            <div
              class="p-3 bg-green-100 rounded-lg group-hover:bg-green-200 transition-colors duration-200"
            >
              <svg
        ...
        >
          <div class="flex items-center mb-4">
            <div
              class="p-3 bg-yellow-100 rounded-lg group-hover:bg-yellow-200 transition-colors duration-200"
            >
              <svg
        ...
        >
          <div class="flex items-center mb-4">
            <div
              class="p-3 bg-purple-100 rounded-lg group-hover:bg-purple-200 transition-colors duration-200"
            >
              <svg
        ...
        >
          <div class="flex items-center mb-4">
            <div
              class="p-3 bg-indigo-100 rounded-lg group-hover:bg-indigo-200 transition-colors duration-200"
            >
              <svg
        ...
        >
          <div class="flex items-center mb-4">
            <div
              class="p-3 bg-gray-100 rounded-lg group-hover:bg-gray-200 transition-colors duration-200"
            >
              <svg
...
@keyframes glowPulse {
  0% {
    box-shadow: 0 0 0px 0 rgba(239, 68, 68, 0.6);
  }
  50% {
