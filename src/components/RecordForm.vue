      ...
      <form @submit.prevent="handleSubmit">
        <div class="space-y-6">
          ...
          <div>
            ...
            <p v-if="errors.medicine" class="mt-1 text-sm text-red-600">{{ errors.medicine }}</p>
          </div>
          ...
          <p v-if="errors.taken_at" class="mt-1 text-sm text-red-600">{{ errors.taken_at }}</p>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                required
              />
              <p v-if="errors.quantity_taken" class="mt-1 text-sm text-red-600">{{ errors.quantity_taken }}</p>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">
              ...
              <p v-if="errors.administration_method" class="mt-1 text-sm text-red-600">{{ errors.administration_method }}</p>
            </div>
          </div>
          ...
          <div v-if="form.status === 'delayed'">
            ...
            <input
              ...
              placeholder="延迟了多少分钟"
            />
            <p v-if="errors.delay_minutes" class="mt-1 text-sm text-red-600">{{ errors.delay_minutes }}</p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              />
              <p v-if="errors.symptom_score" class="mt-1 text-sm text-red-600">{{ errors.symptom_score }}</p>
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">
                效果评分（1-10分）
              ...
              <input
                ...
                placeholder="服药后效果评分"
              />
              <p v-if="errors.effectiveness_score" class="mt-1 text-sm text-red-600">{{ errors.effectiveness_score }}</p>
            </div>
          </div>
          ...
          <div>
            ...
            ></textarea>
            <p v-if="errors.side_effects" class="mt-1 text-sm text-red-600">{{ errors.side_effects }}</p>
          </div>
        </div>
...
const validateForm = () => {
  ...
  if (form.value.symptom_score && (form.value.symptom_score < 1 || form.value.symptom_score > 10)) {
    errors.value.symptom_score = '症状评分必须在1-10之间'
  }
  
  if (form.value.effectiveness_score && (form.value.effectiveness_score < 1 || form.value.effectiveness_score > 10)) {
