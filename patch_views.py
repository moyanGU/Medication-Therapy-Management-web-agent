...
if "def complete_plan" not in content:
    # insert before the end of the file or class. Since it's a class, let's insert before the last blank line
    content = content + "\n" + insert_plan_actions
