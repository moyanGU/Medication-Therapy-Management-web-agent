...
class ReminderHistory(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['response_type'], name='idx_reminder_history_response'),
            models.Index(fields=['user_id', 'sent_at'], name='idx_reminder_history_user_sent'),
        ]
        ordering = ['-sent_at']
    ...
    def mark_responded(self, response_type, notes=None):
        ...
        self.save(update_fields=[
            'responded_at', 'response_type', 
            'response_delay_minutes', 'notes'
        ])
...
class ReminderStats(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['user_id', 'date'], name='idx_reminder_stats_user_date'),
        ]
        ordering = ['-date']
    ...
    def update_from_history(self):
        ...
        self.responded_count = history_records.exclude(response_type='no_response').count()
