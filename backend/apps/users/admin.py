...
class UserAdmin(BaseUserAdmin):
    ...
    """
    list_display = (
        'id', 'username', 'phone', 'email', 'is_active', 'is_staff', 'is_superuser', 'is_admin',
        'date_joined', 'last_login'
    )
    list_filter = (
        'is_active', 'is_staff', 'is_superuser', 'is_admin', 'gender'
    )
    search_fields = (
        'username', 'phone', 'email', 'first_name', 'last_name'
    )
