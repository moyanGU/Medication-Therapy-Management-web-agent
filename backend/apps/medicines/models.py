...
class Medicine(models.Model):
    ...
    name = models.CharField(
        max_length=100, verbose_name="药品名称", help_text="药品的通用名称或商品名称"
    )
    ...
    manufacturer = models.CharField(
        max_length=100, blank=True, null=True, verbose_name="生产厂家", help_text="药品生产厂家名称"
    )

    # 有效期
    expiry_date = models.DateField(
        blank=True, null=True, verbose_name="有效期", help_text="药品有效期至日期"
    )
    ...
    storage_conditions = models.TextField(
        blank=True, null=True, verbose_name="存储条件", help_text="药品存储要求，如温度、湿度、光照等条件"
    )
    ...
    description = EncryptedTextField(
        blank=True, null=True, verbose_name="药品描述", help_text="药品的详细描述信息"
    )
    ...
    is_prescription = models.BooleanField(
        default=False, verbose_name="是否为处方药", help_text="标识是否为处方药"
    )

    # 药品批号
    batch_number = models.CharField(
        max_length=50, blank=True, null=True, verbose_name="药品批号", help_text="药品生产批号"
    )

    # 购买日期
    purchase_date = models.DateField(
        blank=True, null=True, verbose_name="购买日期", help_text="药品购买日期"
    )
