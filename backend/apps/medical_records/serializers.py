...
class MedicalRecordSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MedicalRecord
        fields = [
            'id', 'user', 'visit_date', 'visit_time', 'hospital', 'department', 'doctor',
            'diagnosis', 'chief_complaint', 'present_illness', 'treatment', 'medical_orders',
            'follow_up_date', 'status', 'urgency', 'total_cost', 'insurance_coverage',
            'out_of_pocket_cost', 'satisfaction_score', 'notes', 'attachments',
            'created_at', 'updated_at', 'visit_datetime', 'days_since_visit',
            'days_until_follow_up', 'symptom_improvement', 'is_follow_up_due',
            'prescribed_medicine_names', 'examination_names'
        ]
...
class MedicalRecordCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = MedicalRecord
        fields = [
            'visit_date', 'visit_time', 'hospital', 'department', 'doctor',
            'diagnosis', 'chief_complaint', 'present_illness', 'treatment',
            'medical_orders', 'follow_up_date', 'status', 'urgency', 'total_cost',
            'insurance_coverage', 'satisfaction_score', 'notes', 'attachments',
            'visit_type'
        ]
...
class MedicalRecordListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MedicalRecord
        fields = [
            'id', 'visit_date', 'visit_time', 'hospital', 'department', 'doctor',
            'diagnosis', 'status', 'urgency', 'total_cost', 'satisfaction_score',
            'is_follow_up_due', 'days_since_visit', 'days_until_follow_up', 'visit_type'
        ]
