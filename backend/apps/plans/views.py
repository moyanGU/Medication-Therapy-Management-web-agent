...
from .serializers import MedicationPlanSerializer, MedicationPlanListSerializer
...
class MedicationPlanViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        仅返回当前用户的计划
        """
        return MedicationPlan.objects.filter(user=self.request.user)
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return APIResponse.success(data=MedicationPlanSerializer(serializer.instance).data, message='创建用药计划成功')
    ...
    def update(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            serializer.save()
            return APIResponse.success(data=MedicationPlanSerializer(serializer.instance).data, message='更新用药计划成功')
        return APIResponse.error(message='数据验证失败', errors=serializer.errors)
